...
The WFIRM team is standardizing and validating these airway and skin OTE platforms against existing animal models and human clinical disease. By profiling each model with multi-omics signatures, capturing coordinated changes across genes, proteins, and other molecular markers, the project aims to define reliable fingerprints of chemical injury and of the response to medical countermeasures (MCMs).

The platform supports high-throughput screening of candidate anti-fibrotic therapeutics. Machine learning algorithms then correlate patterns of injury across human tissue, animal models, and clinical disease to predict which classes of countermeasure are most likely to be effective. A further goal is to generate molecular fingerprints of exposure and treatment that enable rapid identification and management of previously uncharacterized chemical threats.
